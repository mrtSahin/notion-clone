...
export const SearchCommand = () => {
  ...
  useEffect(() => {
    ...
    return () => document.removeEventListener('keydown', down) // sayfa destroy edildiginda eventlisteneri siliyoruz
        ...
        <CommandGroup heading="Documents">
          {documents?.map((document) => (
            <CommandItem
              ...
              onSelect={()=>onSelect(document._id)} // üstteki sıkıntıyı gidermek için value değerini yollamak yerine sadece id yi yolluyoruz
            >
              {document.icon ? (
